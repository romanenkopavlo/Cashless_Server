...
export const createPhone = async (req, res) => {
    ...
    return res.status(200).json({message: "Le téléphone a été ajouté.", newPhone: newPhone[0] || null})
}
...
export const updatePhone = async (req, res) => {
    ...
    return res.status(200).json({message: "Le téléphone a été modifié.", updatedPhone: updatedPhone[0] || null})
}
...
export const deletePhone = async (req, res) => {
    ...
    return res.status(200).json({message: "Le téléphone a été supprimé."})
}
